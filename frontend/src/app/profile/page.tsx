      ...
      <div className="bg-white shadow-sm ring-1 ring-slate-200 rounded-2xl overflow-hidden p-8 sm:p-10">
        ...
        {isEditing ? (
          ...
          <div className="flex flex-col gap-6 max-w-md">
             ...
             <div className="pt-6 border-t border-slate-100 mt-2 block w-full">
               <button 
                  onClick={async () => {
                    await supabase.auth.signOut();
                    router.push("/");
                  }}
                  className="w-full sm:w-auto px-6 py-2.5 bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-700 rounded-xl font-medium transition-colors flex items-center justify-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
